...
const MainText = [
  {
    id: 1,
    text: "You Can Check Leagues Rankings By Years",
    link: "/standings/eng.1/2023",
  },
  { id: 2, text: "You Can Check Leagues News", link: "/news/eng.1/page=1" },
  { id: 3, text: "You Can Check Teams by League", link: "/teams" },
  {
    id: 4,
    text: "You Can Check Match by Teams In TeamInfo > MatchResult",
    link: "/teams/eng.1/362",
  },
  {
    id: 5,
    text: "You Can Check Player's Simple Data In TeamInfo > Squad",
    link: "/teams/eng.1/362",
  },
];
const Main = memo(() => {
  ...
  return (
    <div className="bg-[url('../images/background/bg.jpg')] h-screen bg-no-repeat bg-cover text-white">
      <div className="inner">
        <h2 className="text-[60px] text-center">
          Check out the simple soccer data!
        </h2>
